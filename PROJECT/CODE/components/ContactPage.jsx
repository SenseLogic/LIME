...
export default function ContactPage()
{
    ...
    let contactPageInfo = applicationData.contactPageInfo;
                ...
                <div className="contact-page-content-container">
                    ...
                    <div className="contact-page-info-section">
                        ...
                        <div className="contact-page-info-item">
                            ...
                            <p className="contact-page-info-item-text">{ contactPageInfo.email }</p>
                        </div>
                        <div className="contact-page-info-item">
                            <h3 className="contact-page-info-item-title">Phone</h3>
                            <p className="contact-page-info-item-text">{ contactPageInfo.phone }</p>
                        </div>
                        <div className="contact-page-info-item">
                            <h3 className="contact-page-info-item-title">Address</h3>
                            <p className="contact-page-info-item-text">
                                { contactPageInfo.address }<br />
                                { contactPageInfo.city }<br />
                                { contactPageInfo.state }
                            </p>
                        </div>
                        <div className="contact-page-info-item">
                            <h3 className="contact-page-info-item-title">Business Hours</h3>
                            <p className="contact-page-info-item-text">
                                { contactPageInfo.businessHours1 }<br />
                                { contactPageInfo.businessHours2 }<br />
                                { contactPageInfo.businessHours3 }
                            </p>
                        </div>
                    </div>
                </div>
